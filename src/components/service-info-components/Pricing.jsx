  ...
  return (
    <section
      ...
      <div className="container mx-auto py-[60px]">
        ...
        <table className="w-full text-center bg-white border-[1px] border-[#E5E8ED] rounded-[4px] font-[400] text-[16px] text-heading">
          <tr>
            <th
              className="text-left pl-[40px] font-[700] text-[18px]"
              rowSpan={2}>
              <div className="pt-[30px]">Items</div>
            </th>
            <th className="font-[700] text-[24px] pt-[20px]">BASIC</th>
            <th className="font-[700] text-[24px] pt-[20px]">STANDARD</th>
            <th className="font-[700] text-[24px] pt-[20px]">BUSINESS</th>
          </tr>
          <tr>
          ...
          <tr className="bg-[#F4F5F6]">
            <td className="text-left pl-[40px]">Heating floor laying scheme</td>
            <td>
              <div className="flex justify-center items-center py-[10px]">
                <img src="./images/service/check.svg" alt="" />
              </div>
            ...
            <td>
              <div className="py-[30px] flex justify-center items-center">
                <motion.button
                  ...
                  whileHover={{ backgroundColor: "#FF5A30", color: "#FFFFFF" }}
                  className="border-[1px] border-primary rounded-[4px] w-[143px] h-[36px] flex justify-center items-center uppercase font-[700] text-[12px]">
                  send request
                </motion.button>
              </div>
            </td>
